...
const textures: Record<string, THREE.Texture> = {
  cactusSide: loadTexture('./src/assets/textures/cactus_side.png'),
  cactusTop: loadTexture('./src/assets/textures/cactus_top.png'),
  ...
  coalOre: loadTexture('./src/assets/textures/coal_ore.png'),
  ironOre: loadTexture('./src/assets/textures/iron_ore.png'),
  jungleTreeSide: loadTexture('./src/assets/textures/jungle_tree_side.png'),
  jungleTreeTop: loadTexture('./src/assets/textures/jungle_tree_top.png'),
  jungleLeaves: loadTexture('./src/assets/textures/jungle_leaves.png'),
  leaves: loadTexture('./src/assets/textures/leaves.png'),
  treeSide: loadTexture('./src/assets/textures/tree_side.png'),
  treeTop: loadTexture('./src/assets/textures/tree_top.png'),
  sand: loadTexture('./src/assets/textures/sand.png'),
  snow: loadTexture('./src/assets/textures/snow.png'),
  snowSide: loadTexture('./src/assets/textures/snow_side.png'),
  stone: loadTexture('./src/assets/textures/stone.png'),
};
